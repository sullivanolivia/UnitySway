 ...
 * This file demonstrates how to integrate Unitysway with a web frontend
 */

// For React/Vue/Angular applications
export class UnityswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new UnityswayClient(provider, contractAddress);
